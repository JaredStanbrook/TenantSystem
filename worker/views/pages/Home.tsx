  ...
  if (!user) {
    return (
      <div class="flex flex-col items-center justify-center pt-20">
        ...
        <a href="/login" class="mt-4 px-4 py-2 bg-primary text-primary-foreground rounded-md">
          Login
        </a>
      </div>
    );
  ...
  return (
    <div class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        <p>
          <span class="font-semibold">Failed Login Attempts:</span> {user.failedLoginAttempts ?? 0}
        </p>
        {user.lockedUntil && (
          <p>
